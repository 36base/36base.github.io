...
describe('`getDollResourceUrl()`', () => {
  test('returns normal image url', () => {
    expect(getDollResourceUrl('IDWMod', 'normal'))
      .toBe('https://raw.githubusercontent.com/36base/girlsfrontline-resources/next/pic/pic_IDWMod.png');
  });
  test('returns damaged image url', () => {
    expect(getDollResourceUrl('IDWMod', 'damaged', { skin: 2108 }))
      .toBe('https://raw.githubusercontent.com/36base/girlsfrontline-resources/next/pic/pic_IDW_2108_D.png');
  });
  test('returns portrait image url', () => {
    expect(getDollResourceUrl('IDWMod', 'portrait', { skin: 2108 }))
      .toBe('https://raw.githubusercontent.com/36base/girlsfrontline-resources/next/pic/pic_IDW_2108_N_mod.png');
  });
...
describe('`getDollTypeIconUrl()`', () => {
  test('returns typeicon url', () => {
    expect(getDollTypeIconUrl('ar', 7)).toBe('https://raw.githubusercontent.com/36base/girlsfrontline-resources/next/typeicons/gun/AR7.png');
  });
});

describe('`getFairyTypeIconUrl()`', () => {
  test('returns typeicon url', () => {
    expect(getFairyTypeIconUrl('battle')).toBe('https://raw.githubusercontent.com/36base/girlsfrontline-resources/next/typeicons/fairy/battle.png');
  });
});
