...
class EquipPopup extends React.Component {
  constructor(props) {
    ...
    Object.keys(props.stats).forEach((key) => {
      defaultStats[key] = props.stats[key].max;
    });

    this.state = { level: 10, stats: defaultStats };
        ...
        {(data) ? (
          <div className={classes.popup}>
            ...
            <table className={classes.statTable}>
              ...
              <tbody>
                {Object.keys(data.stats).map((key, _) => (
                  <tr>
                    ...
                    <td>
                      <FormControl className={classes.statCustom}>
                        ...
                        <Select
                          ...
                          style={{ color: 'white' }}
                        >
                          {Array((data.stats[key].max - data.stats[key].min) + 1).fill().map((_, i) => {
                            return (
                              <option
                                className={classes.statOption}
